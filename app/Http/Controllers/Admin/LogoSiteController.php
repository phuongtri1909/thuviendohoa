...
class LogoSiteController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'favicon' => 'nullable|image|mimes:jpeg,png,jpg,gif,ico|max:10240',
        ],[
            'logo.max' => 'Logo không được vượt quá 10MB',
            'logo.mimes' => 'Logo phải là hình ảnh',
            'favicon.max' => 'Favicon không được vượt quá 10MB',
            'favicon.mimes' => 'Favicon phải là hình ảnh',
            'favicon.image' => 'Favicon phải là hình ảnh',
            'favicon.ico' => 'Favicon phải là hình ảnh',
        ]);
