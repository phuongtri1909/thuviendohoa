...
class SecureFileUpload
{
                ...
                if (is_array($file)) {
                    foreach ($file as $singleFile) {
                        if (!$this->isFileSafe($singleFile)) {
                            ...
                            $errorMessage = "Chỉ chấp nhận file ảnh (JPG, PNG, GIF, WEBP, ICO). File của bạn có định dạng: $extension ($mimeType)";
    ...
    private function isFileSafe($file): bool
    {
        ...
        $extension = strtolower($file->getClientOriginalExtension());
        if ($extension === 'png' || $extension === 'jpg' || $extension === 'jpeg' || $extension === 'gif' || $extension === 'webp' || $extension === 'ico') {
        } else {
