@if ($contentImage && $contentImage->image)
    @php
        ...
        $buttonText = $contentImage->button_text ?? '> Xem thêm';
        $positionX = $contentImage->button_position_x ?? '50%';
        $positionY = $contentImage->button_position_y ?? '50%';
    ...
    <div class="content-image-wrapper">
        ...
        <a href="{{ $url }}" class="view-more-btn px-3 py-2 text-decoration-none primary-color-5"
