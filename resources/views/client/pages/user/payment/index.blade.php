...
@section('info_section_desc', 'Bạn thân mến! Việc đăng kí VIP, bạn sẽ nhận được các gói XU tương ứng và kích hoạt quyền tải
                ...
                <div class="package-item" data-package-id="{{ $package->id }}">
                    ...
                    <div class="package-content package-bg-content">
                        ...
                        <div class="package-right">
                            <div class="package-feature">Sử dụng: <span class="fw-bold fs-6">{{ $package->expiry }} tháng</span></div>
                            <div class="package-feature">Không giới hạn lượt tải</div>
                            <div class="package-feature">Vĩnh viên nhận <span class="fw-bold fs-6">+ {{ $package->bonus_coins }} XU </span> mỗi tháng</div>
                        </div>
                    </div>
                    ...
                    <div class="package-content package-hover-content">
                        ...
                        <div class="package-divider"></div>
                        <div class="package-right">
                            <div class="package-feature package-feature-colored-{{ $index + 1 }}">Sử dụng: <span class="fw-bold fs-6">{{ $package->expiry }} tháng</span></div>
                            <div class="package-feature package-feature-colored-{{ $index + 1 }}">Không giới hạn lượt tải</div>
                            <div class="package-feature package-feature-colored-{{ $index + 1 }}">Vĩnh viên nhận <span class="fw-bold fs-6">+ {{ $package->bonus_coins }} XU </span> mỗi tháng</div>
                        </div>
                    </div>
                </div>
            @endforeach
        ...
        <script>
            $(document).ready(function() {
                ...
                const coins = response.coins;
                    ...
                    $('#paymentModalLabel').parent().removeClass('package-bronze package-silver package-gold package-platinum').addClass(packageClass);
