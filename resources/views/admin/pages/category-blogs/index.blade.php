    ...
    <div class="category-container">
        <div class="content-card">
            ...
            <div class="filter-section">
                <form action="{{ route('admin.category-blogs.index') }}" method="GET" class="filter-form">
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('admin.category-blogs.index') }}" class="filter-clear-btn">
                ...
                @if ($categories->isEmpty())
                    <div class="empty-state">
                        ...
                        @if (request('name') || request('slug'))
                            ...
                            <a href="{{ route('admin.category-blogs.index') }}" class="action-button">
                                <i class="fas fa-times"></i> Xóa bộ lọc
                            </a>
                        @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.category-blogs.show', $category) }}"
                                                    class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.category-blogs.edit', $category) }}"
