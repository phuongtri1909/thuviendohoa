...
@section('title', 'Quản lý tag blog')
        ...
        <div class="content-card">
            <div class="card-top">
                <div class="card-title">
                    ...
                    <h5>Danh sách tag blog</h5>
                </div>
                <a href="{{ route('admin.tag-blogs.create') }}" class="action-button">
            ...
            <div class="filter-section">
                <form action="{{ route('admin.tag-blogs.index') }}" method="GET" class="filter-form">
                    <div class="row">
                        <div class="col-6">
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="{{ route('admin.tag-blogs.index') }}" class="filter-clear-btn">
                ...
                @if ($tags->isEmpty())
                    <div class="empty-state">
                        ...
                        @if (request('name') || request('slug'))
                            ...
                            <a href="{{ route('admin.tag-blogs.index') }}" class="action-button">
                                <i class="fas fa-times"></i> Xóa bộ lọc
                            </a>
                        @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons-wrapper">
                                                <a href="{{ route('admin.tag-blogs.show', $tag) }}"
                                                    class="action-icon view-icon text-decoration-none" title="Xem chi tiết">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.tag-blogs.edit', $tag) }}"
                                                ...
                                                @include('components.delete-form', [
                                                    'id' => $tag->id,
                                                    'route' => route('admin.tag-blogs.destroy', $tag),
