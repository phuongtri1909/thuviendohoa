...
@section('title', 'Chỉnh sửa tag blog')
    ...
    <div class="form-card">
        <div class="form-header">
            <div class="form-title">
                ...
                <h5>Chỉnh sửa tag blog</h5>
            </div>
            <div class="category-meta">
                <div class="category-badge name">
                    <i class="fas fa-tag"></i>
                    <span>{{ $tagBlog->name }}</span>
                </div>
                <div class="category-badge slug">
                    <i class="fas fa-link"></i>
                    <span>{{ $tagBlog->slug }}</span>
                </div>
                <div class="category-badge created">
                    <i class="fas fa-calendar"></i>
                    <span>Ngày tạo: {{ $tagBlog->created_at->format('d/m/Y H:i') }}</span>
                </div>
            </div>
        </div>
                ...
                <div class="form-tabs">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" 
                               ...
                               value="{{ old('name', $tagBlog->name) }}" required>
