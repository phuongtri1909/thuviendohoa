                ...
                <div class="category-details">
                    <div class="detail-section">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="detail-value stories-count">{{ $category->sets_count }} bộ</span>
                        </div>
                        <div class="detail-item">
                    ...
                    @if ($category->sets->count() > 0)
                        <div class="stories-section">
                            <h6 class="section-title">
                                <i class="fas fa-book"></i>
                                Danh sách bộ trong danh mục ({{ $category->sets->count() }})
                            </h6>
                    ...
                    @else
                        <div class="empty-stories">
                            ...
                            <p>Danh mục này chưa có bộ nào được gán.</p>
                        </div>
                    @endif
                </div>
            </div>
