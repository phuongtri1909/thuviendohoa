                ...
                <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="category-form">
                    ...
                    <div class="form-tabs">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" class="custom-input {{ $errors->has('content') ? 'input-error' : '' }}">{{ old('content', $page->content) }}</textarea>
                            <div class="error-message">
                                @error('content')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="custom-input {{ $errors->has('status') ? 'input-error' : '' }}" required>
                                <option value="1" {{ old('status', $page->status) == 1 ? 'selected' : '' }}>Hoạt động</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="order" name="order" 
                                   ...
                                   value="{{ old('order', $page->order) }}" min="0" required>
                            <div class="form-hint">
                                <i class="fas fa-info-circle"></i>
